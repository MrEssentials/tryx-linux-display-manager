...
IMAGE_SCRIPT = HOME / "tryx_upload.py"
VIDEO_UPLOAD_SCRIPT = HOME / "tryx_video_upload.py"
SELECT_SCRIPT = HOME / "tryx_select_media.py"
LOOP_SCRIPT = HOME / "tryx_loop_media.py"
RESTART_SCRIPT = HOME / "tryx_restart_media.py"
SINGLE_LOOP_MANAGER = HOME / "tryx-linux" / "tryx_loop_manager.py"
